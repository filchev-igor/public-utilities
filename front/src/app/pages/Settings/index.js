...
import { doc, getFirestore, getDoc, updateDoc, collection, addDoc, query, where, getDocs } from 'firebase/firestore';
...
const Settings = async () => {
    ...
    const handleNameUpdate = async () => {
        ...
        if (!confirm(CONFIRM_NAME_CHANGE_EN))
            return false;
    ...
    const handleEmailUpdate = () => {
        ...
        if (!confirm(CONFIRM_EMAIL_CHANGE_EN))
            return false;
    ...
    const handlePasswordUpdate = () => {
        ...
        if (!confirm(CONFIRM_PASSWORD_CHANGE_EN))
            return false;
